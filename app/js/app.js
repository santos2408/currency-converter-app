const initApplication = () => {
    ...
    const switchCurrencies = () => {
        const currencyOneName = currencyOneContainer.querySelector('[data-js="currency-name"] h2') 
        const currencyTwoName = currencyTwoContainer.querySelector('[data-js="currency-name"] h2') 

        changeSelectedBaseCurrency(currencyTwoName.textContent)
        changeSelectedSecondCurrency(currencyOneName.textContent)
    }
    ...
    const loadCurrencies = async selectedCurrency => {
